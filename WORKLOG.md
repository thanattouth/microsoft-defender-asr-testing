...
| 03 - Block execution of potentially obfuscated scripts | Ready | Retest pending | First run reached evidence collection but failed on scalar/empty event `.Count`; event results are now normalized to arrays. No ASR result was assigned to that run. |
